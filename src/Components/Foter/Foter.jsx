    ...
    <div className="bg-[#2a1454]">
        <div className="content pt-20">
           ...
           <div className="item text-white flex justify-center gap-8 text-center mx-auto max-w-2xl">
              ...
              <div className="main cursor-pointer">Experience.</div>
              <div className="main cursor-pointer">Blog.</div>
           </div>
        </div>
        <div className="text text-center py-4 text-[#6341eb]">
            <p>© 2024 All Rights Reserved by Rakib Sheikh</p>
        </div>
    </div>
  )
}
